...
<div class="container bg-light mt-5">
    <div class="row mt-3">
        <div class="col-lg-12 text-center">
            <h2 class="mt-3">CREATE NEW DAT VE</h2>
        </div>
        <div class="col-lg">
            <form:form method="post" action="${contextPath}/datve/create"  modelAttribute="datvedto" id="formDatVe">
			  <div class="form-group d-flex flex-row flex-wrap">
			    <div class="form-group mt-3 col-6">
			        ...
			        <form:input id="cccd" path="cccd" cssClass="form-control" placeholder="Nhập cccd ..."/>
			    ...
			    <div class="form-group mt-3 col-6">
			        ...
			        <form:input id="hoTen" path="hoTen" cssClass="form-control" placeholder="Nhập ten  ..."/>
			    ...
			    <div class="form-group mt-3 col-6">
			        ...
			        <form:input id="ngaySinh" path="ngaySinh" type="date" cssClass="form-control" placeholder="Nhập ngay sinh ..."/>
...
<%-- 			        <form:input id="gioiTinh" path="gioiTinh" cssClass="form-control" placeholder="Nhập gioi tinh ..."/> --%>
			        
			        <form:select path="gioiTinh" id="gioiTinh" cssClass="form-control">
...
<%-- 			        <form:input id="ketQuaXetNghiem" path="ketQuaXetNghiem" cssClass="form-control" placeholder="Nhập ket qua xet nghiem ..."/> --%>
			    ...
			    <div class="form-group mt-3 col-6">
			        ...
			        <form:input id="maDatVe" path="maDatVe" cssClass="form-control" placeholder="Nhập maDatVe ..."/>
			    ...
			    <div class="form-group mt-3 col-6">
			        ...
			        <form:input id="ngayDatVe" path="ngayDatVe" cssClass="form-control" type="date" placeholder="Nhập ngayDatVe ..."/>
			    ...
			    <div class="form-group mt-3 col-6">
			        ...
			        <form:input id="bienSoXe" path="bienSoXe" cssClass="form-control" placeholder="Nhập bienSoXe ..."/>
			    ...
			    <div class="form-group mt-3 col-6">
			        ...
			        <form:input id="diaDiemXuatPhat" path="diaDiemXuatPhat" cssClass="form-control" placeholder="Nhập diaDiemXuatPhat ..."/>
			    ...
			    <div class="form-group mt-3 col-6">
			        ...
			        <form:input id="diaDiemDen" path="diaDiemDen" cssClass="form-control" placeholder="Nhập diaDiemDen ..."/>
			    ...
			    <div class="form-group mt-3 col-6">
			        ...
			        <form:input id="ngayXuatPhat" path="ngayXuatPhat" cssClass="form-control" type="date" placeholder="Nhập ngayXuatPhat ..."/>
